...
namespace ZO.ROS.Controllers {
    ...
    public class ZO4wdDifferentialDriveController : ZOROSUnityGameObjectBase {
        ...
        [SerializeField] [ZOReadOnly] public ZOHingeJoint _frontRightWheelMotor;

        /// <summary>
        /// Hinge joint that drives the right Front wheel.
        /// </summary>
        /// <value></value>
        public ZOHingeJoint FrontRightWheelMotor {
            get => _frontRightWheelMotor;
            set => _frontRightWheelMotor = value;
        }       
        
        [SerializeField] [ZOReadOnly] public ZOHingeJoint _rearRightWheelMotor;

        /// <summary>
        /// Hinge joint that drives the right Back wheel.
        /// </summary>
        /// <value></value>
        public ZOHingeJoint RearRightWheelMotor {
            get => _rearRightWheelMotor;
            set => _rearRightWheelMotor = value;
        }

        [SerializeField] [ZOReadOnly] public ZOHingeJoint _frontLeftWheelMotor;

        /// <summary>
        /// Hinge joint that drive the left Front wheel.
        /// </summary>
        /// <value></value>
        public ZOHingeJoint FrontLeftWheelMotor {
            get => _frontLeftWheelMotor;
            set => _frontLeftWheelMotor = value;
        }

        [SerializeField] [ZOReadOnly] public ZOHingeJoint _rearLeftWheelMotor;

        /// <summary>
        /// Hinge joint that drive the left Back wheel.
        /// </summary>
        /// <value></value>
        public ZOHingeJoint RearLeftWheelMotor
        {
            get => _rearLeftWheelMotor;
            set => _rearLeftWheelMotor = value;
        }
...
void GazeboRosDiffDrive::publishWheelTF()
{
    ...
    for ( int i = 0; i < 2; i++ ) {
        ...
        private void UpdateMotors() {
            ...
            _frontRightWheelMotor.Velocity = rightVelocity * Mathf.Deg2Rad;
            _rearRightWheelMotor.Velocity = rightVelocity * Mathf.Deg2Rad;
            _frontLeftWheelMotor.Velocity = leftVelocity * Mathf.Deg2Rad;
            _rearLeftWheelMotor.Velocity = leftVelocity * Mathf.Deg2Rad;
        }
...
void GazeboRosDiffDrive::UpdateOdometryEncoder()
{
    ...
    odom_.twist.twist.linear.y = dy/seconds_since_last_update;
        ...
        public override void OnROSBridgeConnected(ZOROSUnityManager rosUnityManager)  {
            Debug.Log("INFO: ZO4wdDifferentialDriveController::OnROSBridgeConnected");
        ...
        public override void OnROSBridgeDisconnected(ZOROSUnityManager rosUnityManager) {
            ...
            Debug.Log("INFO: ZO4wdDifferentialDriveController::OnROSBridgeDisconnected");
        }
